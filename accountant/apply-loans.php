                        ...
                        <label for="exampleInputUsername1">Repayment Plan</label>
                         <div class="row">                      
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="repay_plan" id="membershipRadios2" value="12 Months"> 12 Months</label>
                              </div>
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              ...
                              <input type="text" class="form-control" id="exampleInputUsername1" name="loan_date" placeholder="22/10/2021">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
