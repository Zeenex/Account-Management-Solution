        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="page-header">
              <h3 class="page-title text-black"> View Purchased Rice/Oil</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">                  
                  <li class="breadcrumb-item"><a href="purchase-rice.php"><button type="button" class="btn btn-info btn-icon-text"> <i class="mdi mdi-arrow-down-bold-circle"></i> Purchase Rice/Oil </button></a></li>
                </ol>
              </nav>
            </div>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                              ...
                              if(isset($_POST["submit_search"])){
                                  ...
                                  $loaninv = mysqli_query($mysqli, "SELECT * FROM purchaserice WHERE name='".$member_name1."'");
