                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-3">
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="deactive" id="membershipRadios1" value="inactive"> Deactivate </label>
                              </div>
                            </div>
                            <div class="col-sm-3">
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="deactive" id="membershipRadios2" value="active"> Activate </label>
                              </div>
                            </div>
                      ...
                      <button type="submit" name="submit_deactivate" class="btn btn-primary mr-2">Submit</button>
