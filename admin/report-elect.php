...
$iteminv = mysqli_query($mysqli, "SELECT * FROM purchaseitem");
                      ...
                      <table align="center" style="font-size: 14px; margin-top: 10px;border: 1px solid black;border-collapse: collapse; width: 100%;">
                        <thead>
                          <tr>
                            ...
                            <th style="padding: 10px; border: 1px solid black;"> Item Description </th>
...
$output .= '
                ...
                <tr>
                              ...
                              <td style="padding: 10px; border: 1px solid black;">'.$rows['item_desc'].'</td>
                              <td style="padding: 10px; border: 1px solid black;">'.$rows['item_amount'].'</td>
