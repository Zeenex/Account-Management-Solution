...
include("$_SERVER[DOCUMENT_ROOT]/Coporative/accountant/scripts/dashboard.php");
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-loan">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="ongoing-loans.php">View Ongoing Loans</a></li>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-purchase">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="view-rice.php">View Purchased Rice/Oil</a></li>
