                              ...
                              if(isset($_POST["submit_search"])){
								...
								//Selecting database
									...
									if($numrows == 0)
									{
										...
										header("Location: ../fin-record.php?name=$name2&contribution=$contrib&loan=$loan_amount&interest=$interest&form=$form&rice=$r_amount&fine=$fine&gadget=$r_item_amount&total=$total&month=$month1");
										}
										...
										header("Location: ../fin-record.php?name=$name&contribution=$contrib&loan=$loan_amount&interest=$interest&form=$form&rice=$r_amount&fine=$fine&gadget=$r_item_amount&total=$total&month=$month1");
									}
