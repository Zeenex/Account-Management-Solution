...
?>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                              ...
                              <?php
                                    ...
                                    $ongoingloan = mysqli_query($mysqli, "SELECT * FROM loans");
  ...
  ?>
                      ...
                      <div class="row">
                        <div class="col-md-2">
                          <input name="stop" class="btn btn-success" formaction="scripts/loanstop1.php" type="submit" id="stop" value="Approve Loan">
                        </div>
                        <div class="col-md-2">
                          <input name="stop" class="btn btn-danger" formaction="scripts/loanstop1.php" type="submit" id="stop" value="Stop Loan">
                        </div>
                        <div class="col-md-2">
                          <input name="start" class="btn btn-warning" method="post" formaction="scripts/loanstop2.php" type="submit" id="start" value="Start Loan">
                        </div>
                        <div class="col-md-2">
                          <input name="stop" class="btn btn-primary" formaction="scripts/loanstop1.php"type="submit" id="stop" value="Complete Loan">
                        </div>
