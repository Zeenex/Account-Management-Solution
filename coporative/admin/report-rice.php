...
$iteminv = mysqli_query($mysqli, "SELECT * FROM purchaserice");
                      ...
                      <table align="center" style="font-size: 14px; margin-top: 10px;border: 1px solid black;border-collapse: collapse; width: 100%;">
                        <thead>
                          <tr>
                            ...
                            <th style="padding: 10px; border: 1px solid black;"> Rice </th>
                            <th style="padding: 10px; border: 1px solid black;"> Vegetable Oil </th>
                            <th style="padding: 10px; border: 1px solid black;"> Palm Oil </th>
                            <th style="padding: 10px; border: 1px solid black;"> Amount </th>
                            <th style="padding: 10px; border: 1px solid black;"> Interest </th>
...
$output .= '
                ...
                <tr>
                              ...
                              <td style="padding: 10px; border: 1px solid black;">'.$rows['rice'].'</td>
                              <td style="padding: 10px; border: 1px solid black;">'.$rows['vegetable_oil'].'</td>
                              <td style="padding: 10px; border: 1px solid black;">'.$rows['palm_oil'].'</td>
                              <td style="padding: 10px; border: 1px solid black;">'.$rows['amount'].'</td>
